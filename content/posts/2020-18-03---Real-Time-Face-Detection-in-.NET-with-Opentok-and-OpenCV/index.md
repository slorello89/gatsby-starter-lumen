...
draft: false
template: post
slug: "/real-time-face-detection-in-donet-with-opentok-and-opencv"
cover_image: https://www.nexmo.com/wp-content/uploads/2020/03/E_Face-Detection_1200x600.png
date: "2020-03-18T20:49:00Z"
...
tags: 
    ...
    - csharp
    - computervision
description: "Discussion of face detection techniques and building face detection into video calls."
...
![Haar-like feature shapes source: Source https://scc.ustc.edu.cn/](https://www.nexmo.com/wp-content/uploads/2020/03/HaarFeatureShapes.png)
...
![Harr-like Features over Faces source http://www.willberger.org/cascade-haar-explained/](https://www.nexmo.com/wp-content/uploads/2020/03/HaarFeaturesOverFaces.jpg)
...
1. haarcascade\_frontalface\_default.xml
2. haarcascade\_profileface.xml
...
```
copy $(ProjectDir)\haarcascade\_profileface.xml $(ProjectDir)$(OutDir)
copy $(ProjectDir)\haarcascade\_frontalface\_default.xml $(ProjectDir)$(OutDir)
```
...
private CancellationTokenSource _source;private Stopwatch _watch = Stopwatch.StartNew();
```
...
- Once you’ve found the face ROI in your image you can much more efficiently run things like [sentiment analysis](https://dev.to/nexmo/i-see-what-you-re-saying-sentiment-analysis-with-opentok-and-azure-face-api-35h).
...
The post [Real-Time Face Detection in .NET with OpenTok and OpenCV](https://www.nexmo.com/blog/2020/03/18/real-time-face-detection-in-net-with-opentok-and-opencv-dr) appeared first on [Nexmo Developer Blog](https://www.nexmo.com).